								...
								<table class="table table-striped" id="example">
									<thead>
										<tr class="table-success">
											...
											<th style="text-align: left">Jabaran</th>
									...
									<tbody>
										...
										<tr>
											...
											<td style="text-align: left; width: 15%">
												<a href="<?php echo site_url('Pegawai/ubah/'.$row->id); ?>" class="badge badge-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a> |
												<a href="<?php echo site_url('Pegawai/hapus/'.$row->id); ?>" class="badge badge-warning" onClick="return confirm('Anda yakin ?')"><i class="fa fa-trash" aria-hidden="true"></i> Hapus</a>
											</td>
										</tr>
										<?php endforeach; } ?>
									</tbody>
