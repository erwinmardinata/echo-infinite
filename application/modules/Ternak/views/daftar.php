			...
			<div class="card">
				<table class="table" style="border: 1px solid #ddd;color: #000">
					<thead class="table-info">
						<tr>
							<td><strong>Data Ternak</strong></td>
						</tr>
					</thead>
					<tbody>
						<tr>
								...
								<table class="table table-striped" id="example">
									<thead>
										<tr class="table-success">
											...
											<th style="text-align: left">Nama Peternak</th>
											<th style="text-align: left">Entitas</th>
									...
									<tbody>
										...
										<tr>
											...
											<td style="text-align: left"><?php echo $row->no_kartu_ternak; ?></td>
											<td style="text-align: left"><?php echo $row->desa; ?></td>
											<td style="text-align: left"><?php echo $row->nama_peternak; ?></td>
											<td style="text-align: left"><?php echo $row->nama_entitas; ?></td>
											<td style="text-align: left"><?php echo $row->sex; ?></td>
