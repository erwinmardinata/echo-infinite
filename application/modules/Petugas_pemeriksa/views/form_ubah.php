...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card">
				<form class="form-horizontal form-bordered" method="post" action="<?php echo site_url('Petugas_pemeriksa/update'); ?>">
					<br>
					...
					<div class="form-group row">
						...
						<div class="col-md-6">
							...
							<select class="form-control" name="id_pegawai" required="">
								...
								<option <?php echo $data->id_pegawai==$row->id?'selected':''; ?> value="<?php echo $row->id; ?>"><?php echo $row->nama; ?></option>
								<?php endforeach; ?>
							</select>
						</div>
					</div>						
